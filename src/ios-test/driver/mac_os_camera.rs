...
use objc2_av_foundation::{
    AVCaptureConnection, AVCaptureDeviceDiscoverySession, AVCaptureOutput, AVCaptureSession,
    AVCaptureSessionPresetMedium, AVCaptureVideoDataOutput, AVCaptureVideoDataOutputSampleBufferDelegate,
    AVMediaTypeVideo,
};
...
use objc2_core_video::{
    kCVPixelBufferPixelFormatTypeKey, CVPixelBufferGetBaseAddress, CVPixelBufferGetBytesPerRow, CVPixelBufferLockFlags,
};

#[cfg(any(target_os = "ios", target_os = "macos"))]
use objc2_core_video::{
    kCVPixelFormatType_32BGRA, CVPixelBufferGetHeight, CVPixelBufferGetWidth,
};
